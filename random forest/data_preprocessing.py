...
# Read in dataset
dataset = pd.read_csv('{}/{}/{}m_buffer/full_feature_space.csv'.format(base_filepath, aoi, buffer))
...
train.to_csv('{}/{}/{}m_buffer/TrainingData.csv'.format(base_filepath, aoi, buffer))
test.to_csv('{}/{}/{}m_buffer/TestingData.csv'.format(base_filepath, aoi, buffer))
